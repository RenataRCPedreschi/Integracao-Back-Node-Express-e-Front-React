...
export function NovoCliente() {
    //Cliente - front, que recebe as requisições do back
//req.body = data
    ...
    function onSubmit(data) {
        //passar o caminho onde vai salvar os clientes e o objeto a ser salvo
        //a função post retorna sempre uma promessa
        axios.post("http://localhost:3001/clientes", data)
            .then(response => {
                //response é a resposta do back res.status
